...
\title{Do Natural History Documentaries Prompt Public \\Engagement?}
%% title should be less than 90 characters
%% Notice placement of commas and superscripts and use of &
%% in the author list

\author{Adam Kane$^{1}$ \& Dario Fernandez-Bellon$^1$}
...
\begin{affiliations}
 \item Biological, Earth and Environmental Sciences, University College Cork, Cork, Ireland
